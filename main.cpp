...
int ReturnOnlyNumberTwenty() {
    // this function will return number twenty :D
    return 35;
}

#define DISPLAY_TEXT_ONTO_THE_SCREEN_PLEASE cout

int FunctionThatDoesntReturnIntegerTwenty() {
    // this function won't return number twenty
    return 20;
}
...
int main(int argc, char* argv[]) {
    int a = 10;
    int b = ReturnOnlyNumberTwenty() + 3;
    int c = b;
    int d = c;
